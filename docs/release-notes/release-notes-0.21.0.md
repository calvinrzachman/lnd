...
* **switchrpc: Make `SendOnion` RPC Idempotent**

  The `SendOnion` RPC is now fully idempotent, providing a critical reliability
  improvement for external payment orchestrators (such as a remote
