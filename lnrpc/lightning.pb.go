...
const (
	...
	FeatureBit_ROUTE_BLINDING_REQ          FeatureBit = 24
	FeatureBit_ROUTE_BLINDING_OPT          FeatureBit = 25
...
var (
	FeatureBit_name = map[int32]string{
		...
		24: "ROUTE_BLINDING_REQ",
		25: "ROUTE_BLINDING_OPT",
		30: "AMP_REQ",
		31: "AMP_OPT",
	}
	FeatureBit_value = map[string]int32{
		...
		"ROUTE_BLINDING_REQ":          24,
		"ROUTE_BLINDING_OPT":          25,
		"AMP_REQ":                     30,
		"AMP_OPT":                     31,
	}
)
...
// TODO: Update this for route blinding?
...
type QueryRoutesRequest struct {
	...
	HopFeatures []FeatureBit `protobuf:"varint,19,rep,packed,name=hop_features,json=hopFeatures,proto3,enum=lnrpc.FeatureBit" json:"hop_features,omitempty"`
	// Indicate that the route we are searching for is to be a blinded route
	// and, as such, that each hop must support route blinding.
	// Likely table this approach in favor of the more general method of
	// requiring arbitrary feature support for intermediate hops outlined above.
	RouteBlinding bool `protobuf:"varint,20,opt,name=route_blinding,json=routeBlinding,proto3" json:"route_blinding,omitempty"`
}
...
func (x *QueryRoutesRequest) GetHopFeatures() []FeatureBit {
	if x != nil {
		return x.HopFeatures
	}
	return nil
}

func (x *QueryRoutesRequest) GetRouteBlinding() bool {
	if x != nil {
		return x.RouteBlinding
	}
	return false
}
...
type Hop struct {
	...
	// An optional TLV record that signals the use of the route blinding protocol.
	// If present, ...
	//
	// We could either:
	// - Put both fields in a single route blinding "box" (message/struct)
	// - Individually include both route blinding fields
	RouteBlindingRecord *RouteBlindingRecord `protobuf:"bytes,14,opt,name=route_blinding_record,json=routeBlindingRecord,proto3" json:"route_blinding_record,omitempty"`
}
...
func (x *Hop) GetRouteBlindingRecord() *RouteBlindingRecord {
	if x != nil {
		return x.RouteBlindingRecord
	}
	return nil
}

type RouteBlindingRecord struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	BlindingPoint    string `protobuf:"bytes,1,opt,name=blinding_point,json=blindingPoint,proto3" json:"blinding_point,omitempty"`
...
func (x *RouteBlindingRecord) Reset() {
	*x = RouteBlindingRecord{}
	if protoimpl.UnsafeEnabled {
...
func (x *RouteBlindingRecord) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*RouteBlindingRecord) ProtoMessage() {}

func (x *RouteBlindingRecord) ProtoReflect() protoreflect.Message {
	mi := &file_lightning_proto_msgTypes[98]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use RouteBlindingRecord.ProtoReflect.Descriptor instead.
func (*RouteBlindingRecord) Descriptor() ([]byte, []int) {
	return file_lightning_proto_rawDescGZIP(), []int{98}
}

func (x *RouteBlindingRecord) GetBlindingPoint() string {
	if x != nil {
...
func (x *RouteBlindingRecord) GetEncryptedPayload() []byte {
	if x != nil {
...
type Route struct {
	...
	// NOTE: The source node of a route is NOT included in the list of hops.
	// Usually the source node for a route is assumed to be ourselves.
	...
	// The source node for the route. If empty, self is assumed.
	SourcePubKey string `protobuf:"bytes,7,opt,name=source_pub_key,json=sourcePubKey,proto3" json:"source_pub_key,omitempty"`
}
...
var file_lightning_proto_rawDesc = []byte{
	...
	0x65, 0x42, 0x61, 0x6c, 0x61, 0x6e, 0x63, 0x65, 0x22, 0xa8, 0x07, 0x0a, 0x12, 0x51, 0x75, 0x65,
	...
	0x52, 0x08, 0x74, 0x69, 0x6d, 0x65, 0x50, 0x72, 0x65, 0x66, 0x12, 0x34, 0x0a, 0x0c, 0x68, 0x6f,
	0x70, 0x5f, 0x66, 0x65, 0x61, 0x74, 0x75, 0x72, 0x65, 0x73, 0x18, 0x13, 0x20, 0x03, 0x28, 0x0e,
	0x32, 0x11, 0x2e, 0x6c, 0x6e, 0x72, 0x70, 0x63, 0x2e, 0x46, 0x65, 0x61, 0x74, 0x75, 0x72, 0x65,
	0x42, 0x69, 0x74, 0x52, 0x0b, 0x68, 0x6f, 0x70, 0x46, 0x65, 0x61, 0x74, 0x75, 0x72, 0x65, 0x73,
	0x12, 0x25, 0x0a, 0x0e, 0x72, 0x6f, 0x75, 0x74, 0x65, 0x5f, 0x62, 0x6c, 0x69, 0x6e, 0x64, 0x69,
	0x6e, 0x67, 0x18, 0x14, 0x20, 0x01, 0x28, 0x08, 0x52, 0x0d, 0x72, 0x6f, 0x75, 0x74, 0x65, 0x42,
	0x6c, 0x69, 0x6e, 0x64, 0x69, 0x6e, 0x67, 0x1a, 0x44, 0x0a, 0x16, 0x44, 0x65, 0x73, 0x74, 0x43,
	...
	0x6f, 0x62, 0x22, 0x81, 0x05, 0x0a, 0x03, 0x48, 0x6f, 0x70, 0x12, 0x1b, 0x0a, 0x07, 0x63, 0x68,
	...
	0x64, 0x61, 0x74, 0x61, 0x12, 0x4e, 0x0a, 0x15, 0x72, 0x6f, 0x75, 0x74, 0x65, 0x5f, 0x62, 0x6c,
	0x69, 0x6e, 0x64, 0x69, 0x6e, 0x67, 0x5f, 0x72, 0x65, 0x63, 0x6f, 0x72, 0x64, 0x18, 0x0e, 0x20,
	0x01, 0x28, 0x0b, 0x32, 0x1a, 0x2e, 0x6c, 0x6e, 0x72, 0x70, 0x63, 0x2e, 0x52, 0x6f, 0x75, 0x74,
	0x65, 0x42, 0x6c, 0x69, 0x6e, 0x64, 0x69, 0x6e, 0x67, 0x52, 0x65, 0x63, 0x6f, 0x72, 0x64, 0x52,
	0x13, 0x72, 0x6f, 0x75, 0x74, 0x65, 0x42, 0x6c, 0x69, 0x6e, 0x64, 0x69, 0x6e, 0x67, 0x52, 0x65,
	0x63, 0x6f, 0x72, 0x64, 0x1a, 0x40, 0x0a, 0x12, 0x43, 0x75, 0x73, 0x74, 0x6f, 0x6d, 0x52, 0x65,
	...
	,
	...
	0x0a, 0x63, 0x68, 0x69, 0x6c, 0x64, 0x49, 0x6e, 0x64, 0x65, 0x78, 0x22, 0x87, 0x02, 0x0a, 0x05,
	...
	0x24, 0x0a, 0x0e, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x5f, 0x70, 0x75, 0x62, 0x5f, 0x6b, 0x65,
	0x79, 0x18, 0x07, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0c, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x50,
	0x75, 0x62, 0x4b, 0x65, 0x79, 0x22, 0x55, 0x0a, 0x0f, 0x4e, 0x6f, 0x64, 0x65, 0x49, 0x6e, 0x66,
	...
	0xd8, 0x01, 0x0a, 0x13, 0x4c, 0x69, 0x73, 0x74, 0x50, 0x61, 0x79, 0x6d, 0x65, 0x6e, 0x74, 0x73,
	...
	0x61, 0x6c, 0x50, 0x61, 0x79, 0x6d, 0x65, 0x6e, 0x74, 0x73, 0x22, 0xca, 0x01, 0x0a, 0x14, 0x4c,
	...
	0x45, 0x10, 0x05, 0x2a, 0xff, 0x04, 0x0a, 0x0a, 0x46, 0x65, 0x61, 0x74, 0x75, 0x72, 0x65, 0x42,
	...
	0x5f, 0x48, 0x54, 0x4c, 0x43, 0x5f, 0x4f, 0x50, 0x54, 0x10, 0x17, 0x12, 0x16, 0x0a, 0x12, 0x52,
	0x4f, 0x55, 0x54, 0x45, 0x5f, 0x42, 0x4c, 0x49, 0x4e, 0x44, 0x49, 0x4e, 0x47, 0x5f, 0x52, 0x45,
	0x51, 0x10, 0x18, 0x12, 0x16, 0x0a, 0x12, 0x52, 0x4f, 0x55, 0x54, 0x45, 0x5f, 0x42, 0x4c, 0x49,
	0x4e, 0x44, 0x49, 0x4e, 0x47, 0x5f, 0x4f, 0x50, 0x54, 0x10, 0x19, 0x12, 0x0b, 0x0a, 0x07, 0x41,
...
var file_lightning_proto_goTypes = []interface{}{
	...
	(*RouteBlindingRecord)(nil),                                 // 118: lnrpc.RouteBlindingRecord
	(*MPPRecord)(nil),                                           // 119: lnrpc.MPPRecord
	(*AMPRecord)(nil),                                           // 120: lnrpc.AMPRecord
	(*Route)(nil),                                               // 121: lnrpc.Route
	(*NodeInfoRequest)(nil),                                     // 122: lnrpc.NodeInfoRequest
	(*NodeInfo)(nil),                                            // 123: lnrpc.NodeInfo
	(*LightningNode)(nil),                                       // 124: lnrpc.LightningNode
	(*NodeAddress)(nil),                                         // 125: lnrpc.NodeAddress
	(*RoutingPolicy)(nil),                                       // 126: lnrpc.RoutingPolicy
	(*ChannelEdge)(nil),                                         // 127: lnrpc.ChannelEdge
	(*ChannelGraphRequest)(nil),                                 // 128: lnrpc.ChannelGraphRequest
	(*ChannelGraph)(nil),                                        // 129: lnrpc.ChannelGraph
	(*NodeMetricsRequest)(nil),                                  // 130: lnrpc.NodeMetricsRequest
	(*NodeMetricsResponse)(nil),                                 // 131: lnrpc.NodeMetricsResponse
	(*FloatMetric)(nil),                                         // 132: lnrpc.FloatMetric
	(*ChanInfoRequest)(nil),                                     // 133: lnrpc.ChanInfoRequest
	(*NetworkInfoRequest)(nil),                                  // 134: lnrpc.NetworkInfoRequest
	(*NetworkInfo)(nil),                                         // 135: lnrpc.NetworkInfo
	(*StopRequest)(nil),                                         // 136: lnrpc.StopRequest
	(*StopResponse)(nil),                                        // 137: lnrpc.StopResponse
	(*GraphTopologySubscription)(nil),                           // 138: lnrpc.GraphTopologySubscription
	(*GraphTopologyUpdate)(nil),                                 // 139: lnrpc.GraphTopologyUpdate
	(*NodeUpdate)(nil),                                          // 140: lnrpc.NodeUpdate
	(*ChannelEdgeUpdate)(nil),                                   // 141: lnrpc.ChannelEdgeUpdate
	(*ClosedChannelUpdate)(nil),                                 // 142: lnrpc.ClosedChannelUpdate
	(*HopHint)(nil),                                             // 143: lnrpc.HopHint
	(*SetID)(nil),                                               // 144: lnrpc.SetID
	(*RouteHint)(nil),                                           // 145: lnrpc.RouteHint
	(*AMPInvoiceState)(nil),                                     // 146: lnrpc.AMPInvoiceState
	(*Invoice)(nil),                                             // 147: lnrpc.Invoice
	(*InvoiceHTLC)(nil),                                         // 148: lnrpc.InvoiceHTLC
	(*AMP)(nil),                                                 // 149: lnrpc.AMP
	(*AddInvoiceResponse)(nil),                                  // 150: lnrpc.AddInvoiceResponse
	(*PaymentHash)(nil),                                         // 151: lnrpc.PaymentHash
	(*ListInvoiceRequest)(nil),                                  // 152: lnrpc.ListInvoiceRequest
	(*ListInvoiceResponse)(nil),                                 // 153: lnrpc.ListInvoiceResponse
	(*InvoiceSubscription)(nil),                                 // 154: lnrpc.InvoiceSubscription
	(*Payment)(nil),                                             // 155: lnrpc.Payment
	(*HTLCAttempt)(nil),                                         // 156: lnrpc.HTLCAttempt
	(*ListPaymentsRequest)(nil),                                 // 157: lnrpc.ListPaymentsRequest
	(*ListPaymentsResponse)(nil),                                // 158: lnrpc.ListPaymentsResponse
	(*DeletePaymentRequest)(nil),                                // 159: lnrpc.DeletePaymentRequest
	(*DeleteAllPaymentsRequest)(nil),                            // 160: lnrpc.DeleteAllPaymentsRequest
	(*DeletePaymentResponse)(nil),                               // 161: lnrpc.DeletePaymentResponse
	(*DeleteAllPaymentsResponse)(nil),                           // 162: lnrpc.DeleteAllPaymentsResponse
	(*AbandonChannelRequest)(nil),                               // 163: lnrpc.AbandonChannelRequest
	(*AbandonChannelResponse)(nil),                              // 164: lnrpc.AbandonChannelResponse
	(*DebugLevelRequest)(nil),                                   // 165: lnrpc.DebugLevelRequest
	(*DebugLevelResponse)(nil),                                  // 166: lnrpc.DebugLevelResponse
	(*PayReqString)(nil),                                        // 167: lnrpc.PayReqString
	(*PayReq)(nil),                                              // 168: lnrpc.PayReq
	(*Feature)(nil),                                             // 169: lnrpc.Feature
	(*FeeReportRequest)(nil),                                    // 170: lnrpc.FeeReportRequest
	(*ChannelFeeReport)(nil),                                    // 171: lnrpc.ChannelFeeReport
	(*FeeReportResponse)(nil),                                   // 172: lnrpc.FeeReportResponse
	(*PolicyUpdateRequest)(nil),                                 // 173: lnrpc.PolicyUpdateRequest
	(*FailedUpdate)(nil),                                        // 174: lnrpc.FailedUpdate
	(*PolicyUpdateResponse)(nil),                                // 175: lnrpc.PolicyUpdateResponse
	(*ForwardingHistoryRequest)(nil),                            // 176: lnrpc.ForwardingHistoryRequest
	(*ForwardingEvent)(nil),                                     // 177: lnrpc.ForwardingEvent
	(*ForwardingHistoryResponse)(nil),                           // 178: lnrpc.ForwardingHistoryResponse
	(*ExportChannelBackupRequest)(nil),                          // 179: lnrpc.ExportChannelBackupRequest
	(*ChannelBackup)(nil),                                       // 180: lnrpc.ChannelBackup
	(*MultiChanBackup)(nil),                                     // 181: lnrpc.MultiChanBackup
	(*ChanBackupExportRequest)(nil),                             // 182: lnrpc.ChanBackupExportRequest
	(*ChanBackupSnapshot)(nil),                                  // 183: lnrpc.ChanBackupSnapshot
	(*ChannelBackups)(nil),                                      // 184: lnrpc.ChannelBackups
	(*RestoreChanBackupRequest)(nil),                            // 185: lnrpc.RestoreChanBackupRequest
	(*RestoreBackupResponse)(nil),                               // 186: lnrpc.RestoreBackupResponse
	(*ChannelBackupSubscription)(nil),                           // 187: lnrpc.ChannelBackupSubscription
	(*VerifyChanBackupResponse)(nil),                            // 188: lnrpc.VerifyChanBackupResponse
	(*MacaroonPermission)(nil),                                  // 189: lnrpc.MacaroonPermission
	(*BakeMacaroonRequest)(nil),                                 // 190: lnrpc.BakeMacaroonRequest
	(*BakeMacaroonResponse)(nil),                                // 191: lnrpc.BakeMacaroonResponse
	(*ListMacaroonIDsRequest)(nil),                              // 192: lnrpc.ListMacaroonIDsRequest
	(*ListMacaroonIDsResponse)(nil),                             // 193: lnrpc.ListMacaroonIDsResponse
	(*DeleteMacaroonIDRequest)(nil),                             // 194: lnrpc.DeleteMacaroonIDRequest
	(*DeleteMacaroonIDResponse)(nil),                            // 195: lnrpc.DeleteMacaroonIDResponse
	(*MacaroonPermissionList)(nil),                              // 196: lnrpc.MacaroonPermissionList
	(*ListPermissionsRequest)(nil),                              // 197: lnrpc.ListPermissionsRequest
	(*ListPermissionsResponse)(nil),                             // 198: lnrpc.ListPermissionsResponse
...
var file_lightning_proto_depIdxs = []int32{
	...
	211, // 7: lnrpc.SendRequest.dest_custom_records:type_name -> lnrpc.SendRequest.DestCustomRecordsEntry
	9,   // 8: lnrpc.SendRequest.dest_features:type_name -> lnrpc.FeatureBit
	121, // 9: lnrpc.SendResponse.payment_route:type_name -> lnrpc.Route
	121, // 10: lnrpc.SendToRouteRequest.route:type_name -> lnrpc.Route
	2,   // 11: lnrpc.ChannelAcceptRequest.commitment_type:type_name -> lnrpc.CommitmentType
	212, // 12: lnrpc.EstimateFeeRequest.AddrToAmount:type_name -> lnrpc.EstimateFeeRequest.AddrToAmountEntry
	213, // 13: lnrpc.SendManyRequest.AddrToAmount:type_name -> lnrpc.SendManyRequest.AddrToAmountEntry
	...
	145, // 81: lnrpc.QueryRoutesRequest.route_hints:type_name -> lnrpc.RouteHint
	9,   // 82: lnrpc.QueryRoutesRequest.dest_features:type_name -> lnrpc.FeatureBit
	9,   // 83: lnrpc.QueryRoutesRequest.hop_features:type_name -> lnrpc.FeatureBit
	121, // 84: lnrpc.QueryRoutesResponse.routes:type_name -> lnrpc.Route
	119, // 85: lnrpc.Hop.mpp_record:type_name -> lnrpc.MPPRecord
	120, // 86: lnrpc.Hop.amp_record:type_name -> lnrpc.AMPRecord
	224, // 87: lnrpc.Hop.custom_records:type_name -> lnrpc.Hop.CustomRecordsEntry
	118, // 88: lnrpc.Hop.route_blinding_record:type_name -> lnrpc.RouteBlindingRecord
	117, // 89: lnrpc.Route.hops:type_name -> lnrpc.Hop
	124, // 90: lnrpc.NodeInfo.node:type_name -> lnrpc.LightningNode
	127, // 91: lnrpc.NodeInfo.channels:type_name -> lnrpc.ChannelEdge
	125, // 92: lnrpc.LightningNode.addresses:type_name -> lnrpc.NodeAddress
	225, // 93: lnrpc.LightningNode.features:type_name -> lnrpc.LightningNode.FeaturesEntry
	126, // 94: lnrpc.ChannelEdge.node1_policy:type_name -> lnrpc.RoutingPolicy
	126, // 95: lnrpc.ChannelEdge.node2_policy:type_name -> lnrpc.RoutingPolicy
	124, // 96: lnrpc.ChannelGraph.nodes:type_name -> lnrpc.LightningNode
	127, // 97: lnrpc.ChannelGraph.edges:type_name -> lnrpc.ChannelEdge
	6,   // 98: lnrpc.NodeMetricsRequest.types:type_name -> lnrpc.NodeMetricType
	226, // 99: lnrpc.NodeMetricsResponse.betweenness_centrality:type_name -> lnrpc.NodeMetricsResponse.BetweennessCentralityEntry
	140, // 100: lnrpc.GraphTopologyUpdate.node_updates:type_name -> lnrpc.NodeUpdate
	141, // 101: lnrpc.GraphTopologyUpdate.channel_updates:type_name -> lnrpc.ChannelEdgeUpdate
	142, // 102: lnrpc.GraphTopologyUpdate.closed_chans:type_name -> lnrpc.ClosedChannelUpdate
	125, // 103: lnrpc.NodeUpdate.node_addresses:type_name -> lnrpc.NodeAddress
	227, // 104: lnrpc.NodeUpdate.features:type_name -> lnrpc.NodeUpdate.FeaturesEntry
	35,  // 105: lnrpc.ChannelEdgeUpdate.chan_point:type_name -> lnrpc.ChannelPoint
	126, // 106: lnrpc.ChannelEdgeUpdate.routing_policy:type_name -> lnrpc.RoutingPolicy
	35,  // 107: lnrpc.ClosedChannelUpdate.chan_point:type_name -> lnrpc.ChannelPoint
	143, // 108: lnrpc.RouteHint.hop_hints:type_name -> lnrpc.HopHint
	7,   // 109: lnrpc.AMPInvoiceState.state:type_name -> lnrpc.InvoiceHTLCState
	145, // 110: lnrpc.Invoice.route_hints:type_name -> lnrpc.RouteHint
	16,  // 111: lnrpc.Invoice.state:type_name -> lnrpc.Invoice.InvoiceState
	148, // 112: lnrpc.Invoice.htlcs:type_name -> lnrpc.InvoiceHTLC
	228, // 113: lnrpc.Invoice.features:type_name -> lnrpc.Invoice.FeaturesEntry
	229, // 114: lnrpc.Invoice.amp_invoice_state:type_name -> lnrpc.Invoice.AmpInvoiceStateEntry
	7,   // 115: lnrpc.InvoiceHTLC.state:type_name -> lnrpc.InvoiceHTLCState
	230, // 116: lnrpc.InvoiceHTLC.custom_records:type_name -> lnrpc.InvoiceHTLC.CustomRecordsEntry
	149, // 117: lnrpc.InvoiceHTLC.amp:type_name -> lnrpc.AMP
	147, // 118: lnrpc.ListInvoiceResponse.invoices:type_name -> lnrpc.Invoice
	17,  // 119: lnrpc.Payment.status:type_name -> lnrpc.Payment.PaymentStatus
	156, // 120: lnrpc.Payment.htlcs:type_name -> lnrpc.HTLCAttempt
	8,   // 121: lnrpc.Payment.failure_reason:type_name -> lnrpc.PaymentFailureReason
	18,  // 122: lnrpc.HTLCAttempt.status:type_name -> lnrpc.HTLCAttempt.HTLCStatus
	121, // 123: lnrpc.HTLCAttempt.route:type_name -> lnrpc.Route
	199, // 124: lnrpc.HTLCAttempt.failure:type_name -> lnrpc.Failure
	155, // 125: lnrpc.ListPaymentsResponse.payments:type_name -> lnrpc.Payment
	35,  // 126: lnrpc.AbandonChannelRequest.channel_point:type_name -> lnrpc.ChannelPoint
	145, // 127: lnrpc.PayReq.route_hints:type_name -> lnrpc.RouteHint
	231, // 128: lnrpc.PayReq.features:type_name -> lnrpc.PayReq.FeaturesEntry
	171, // 129: lnrpc.FeeReportResponse.channel_fees:type_name -> lnrpc.ChannelFeeReport
	35,  // 130: lnrpc.PolicyUpdateRequest.chan_point:type_name -> lnrpc.ChannelPoint
	36,  // 131: lnrpc.FailedUpdate.outpoint:type_name -> lnrpc.OutPoint
	10,  // 132: lnrpc.FailedUpdate.reason:type_name -> lnrpc.UpdateFailure
	174, // 133: lnrpc.PolicyUpdateResponse.failed_updates:type_name -> lnrpc.FailedUpdate
	177, // 134: lnrpc.ForwardingHistoryResponse.forwarding_events:type_name -> lnrpc.ForwardingEvent
	35,  // 135: lnrpc.ExportChannelBackupRequest.chan_point:type_name -> lnrpc.ChannelPoint
	35,  // 136: lnrpc.ChannelBackup.chan_point:type_name -> lnrpc.ChannelPoint
	35,  // 137: lnrpc.MultiChanBackup.chan_points:type_name -> lnrpc.ChannelPoint
	184, // 138: lnrpc.ChanBackupSnapshot.single_chan_backups:type_name -> lnrpc.ChannelBackups
	181, // 139: lnrpc.ChanBackupSnapshot.multi_chan_backup:type_name -> lnrpc.MultiChanBackup
	180, // 140: lnrpc.ChannelBackups.chan_backups:type_name -> lnrpc.ChannelBackup
	184, // 141: lnrpc.RestoreChanBackupRequest.chan_backups:type_name -> lnrpc.ChannelBackups
	189, // 142: lnrpc.BakeMacaroonRequest.permissions:type_name -> lnrpc.MacaroonPermission
	189, // 143: lnrpc.MacaroonPermissionList.permissions:type_name -> lnrpc.MacaroonPermission
	232, // 144: lnrpc.ListPermissionsResponse.method_permissions:type_name -> lnrpc.ListPermissionsResponse.MethodPermissionsEntry
	19,  // 145: lnrpc.Failure.code:type_name -> lnrpc.Failure.FailureCode
	200, // 146: lnrpc.Failure.channel_update:type_name -> lnrpc.ChannelUpdate
	202, // 147: lnrpc.MacaroonId.ops:type_name -> lnrpc.Op
	189, // 148: lnrpc.CheckMacPermRequest.permissions:type_name -> lnrpc.MacaroonPermission
	206, // 149: lnrpc.RPCMiddlewareRequest.stream_auth:type_name -> lnrpc.StreamAuth
	207, // 150: lnrpc.RPCMiddlewareRequest.request:type_name -> lnrpc.RPCMessage
	207, // 151: lnrpc.RPCMiddlewareRequest.response:type_name -> lnrpc.RPCMessage
	209, // 152: lnrpc.RPCMiddlewareResponse.register:type_name -> lnrpc.MiddlewareRegistration
	210, // 153: lnrpc.RPCMiddlewareResponse.feedback:type_name -> lnrpc.InterceptFeedback
	169, // 154: lnrpc.Peer.FeaturesEntry.value:type_name -> lnrpc.Feature
	169, // 155: lnrpc.GetInfoResponse.FeaturesEntry.value:type_name -> lnrpc.Feature
	3,   // 156: lnrpc.PendingChannelsResponse.PendingChannel.initiator:type_name -> lnrpc.Initiator
	2,   // 157: lnrpc.PendingChannelsResponse.PendingChannel.commitment_type:type_name -> lnrpc.CommitmentType
	216, // 158: lnrpc.PendingChannelsResponse.PendingOpenChannel.channel:type_name -> lnrpc.PendingChannelsResponse.PendingChannel
	216, // 159: lnrpc.PendingChannelsResponse.WaitingCloseChannel.channel:type_name -> lnrpc.PendingChannelsResponse.PendingChannel
	219, // 160: lnrpc.PendingChannelsResponse.WaitingCloseChannel.commitments:type_name -> lnrpc.PendingChannelsResponse.Commitments
	216, // 161: lnrpc.PendingChannelsResponse.ClosedChannel.channel:type_name -> lnrpc.PendingChannelsResponse.PendingChannel
	216, // 162: lnrpc.PendingChannelsResponse.ForceClosedChannel.channel:type_name -> lnrpc.PendingChannelsResponse.PendingChannel
	102, // 163: lnrpc.PendingChannelsResponse.ForceClosedChannel.pending_htlcs:type_name -> lnrpc.PendingHTLC
	14,  // 164: lnrpc.PendingChannelsResponse.ForceClosedChannel.anchor:type_name -> lnrpc.PendingChannelsResponse.ForceClosedChannel.AnchorState
	107, // 165: lnrpc.WalletBalanceResponse.AccountBalanceEntry.value:type_name -> lnrpc.WalletAccountBalance
	169, // 166: lnrpc.LightningNode.FeaturesEntry.value:type_name -> lnrpc.Feature
	132, // 167: lnrpc.NodeMetricsResponse.BetweennessCentralityEntry.value:type_name -> lnrpc.FloatMetric
	169, // 168: lnrpc.NodeUpdate.FeaturesEntry.value:type_name -> lnrpc.Feature
	169, // 169: lnrpc.Invoice.FeaturesEntry.value:type_name -> lnrpc.Feature
	146, // 170: lnrpc.Invoice.AmpInvoiceStateEntry.value:type_name -> lnrpc.AMPInvoiceState
	169, // 171: lnrpc.PayReq.FeaturesEntry.value:type_name -> lnrpc.Feature
	196, // 172: lnrpc.ListPermissionsResponse.MethodPermissionsEntry.value:type_name -> lnrpc.MacaroonPermissionList
	108, // 173: lnrpc.Lightning.WalletBalance:input_type -> lnrpc.WalletBalanceRequest
	111, // 174: lnrpc.Lightning.ChannelBalance:input_type -> lnrpc.ChannelBalanceRequest
	27,  // 175: lnrpc.Lightning.GetTransactions:input_type -> lnrpc.GetTransactionsRequest
	39,  // 176: lnrpc.Lightning.EstimateFee:input_type -> lnrpc.EstimateFeeRequest
	43,  // 177: lnrpc.Lightning.SendCoins:input_type -> lnrpc.SendCoinsRequest
	45,  // 178: lnrpc.Lightning.ListUnspent:input_type -> lnrpc.ListUnspentRequest
	27,  // 179: lnrpc.Lightning.SubscribeTransactions:input_type -> lnrpc.GetTransactionsRequest
	41,  // 180: lnrpc.Lightning.SendMany:input_type -> lnrpc.SendManyRequest
	47,  // 181: lnrpc.Lightning.NewAddress:input_type -> lnrpc.NewAddressRequest
	49,  // 182: lnrpc.Lightning.SignMessage:input_type -> lnrpc.SignMessageRequest
	51,  // 183: lnrpc.Lightning.VerifyMessage:input_type -> lnrpc.VerifyMessageRequest
	53,  // 184: lnrpc.Lightning.ConnectPeer:input_type -> lnrpc.ConnectPeerRequest
	55,  // 185: lnrpc.Lightning.DisconnectPeer:input_type -> lnrpc.DisconnectPeerRequest
	71,  // 186: lnrpc.Lightning.ListPeers:input_type -> lnrpc.ListPeersRequest
	73,  // 187: lnrpc.Lightning.SubscribePeerEvents:input_type -> lnrpc.PeerEventSubscription
	75,  // 188: lnrpc.Lightning.GetInfo:input_type -> lnrpc.GetInfoRequest
	77,  // 189: lnrpc.Lightning.GetRecoveryInfo:input_type -> lnrpc.GetRecoveryInfoRequest
	103, // 190: lnrpc.Lightning.PendingChannels:input_type -> lnrpc.PendingChannelsRequest
	60,  // 191: lnrpc.Lightning.ListChannels:input_type -> lnrpc.ListChannelsRequest
	105, // 192: lnrpc.Lightning.SubscribeChannelEvents:input_type -> lnrpc.ChannelEventSubscription
	67,  // 193: lnrpc.Lightning.ClosedChannels:input_type -> lnrpc.ClosedChannelsRequest
	90,  // 194: lnrpc.Lightning.OpenChannelSync:input_type -> lnrpc.OpenChannelRequest
	90,  // 195: lnrpc.Lightning.OpenChannel:input_type -> lnrpc.OpenChannelRequest
	87,  // 196: lnrpc.Lightning.BatchOpenChannel:input_type -> lnrpc.BatchOpenChannelRequest
	100, // 197: lnrpc.Lightning.FundingStateStep:input_type -> lnrpc.FundingTransitionMsg
	34,  // 198: lnrpc.Lightning.ChannelAcceptor:input_type -> lnrpc.ChannelAcceptResponse
	83,  // 199: lnrpc.Lightning.CloseChannel:input_type -> lnrpc.CloseChannelRequest
	163, // 200: lnrpc.Lightning.AbandonChannel:input_type -> lnrpc.AbandonChannelRequest
	30,  // 201: lnrpc.Lightning.SendPayment:input_type -> lnrpc.SendRequest
	30,  // 202: lnrpc.Lightning.SendPaymentSync:input_type -> lnrpc.SendRequest
	32,  // 203: lnrpc.Lightning.SendToRoute:input_type -> lnrpc.SendToRouteRequest
	32,  // 204: lnrpc.Lightning.SendToRouteSync:input_type -> lnrpc.SendToRouteRequest
	147, // 205: lnrpc.Lightning.AddInvoice:input_type -> lnrpc.Invoice
	152, // 206: lnrpc.Lightning.ListInvoices:input_type -> lnrpc.ListInvoiceRequest
	151, // 207: lnrpc.Lightning.LookupInvoice:input_type -> lnrpc.PaymentHash
	154, // 208: lnrpc.Lightning.SubscribeInvoices:input_type -> lnrpc.InvoiceSubscription
	167, // 209: lnrpc.Lightning.DecodePayReq:input_type -> lnrpc.PayReqString
	157, // 210: lnrpc.Lightning.ListPayments:input_type -> lnrpc.ListPaymentsRequest
	159, // 211: lnrpc.Lightning.DeletePayment:input_type -> lnrpc.DeletePaymentRequest
	160, // 212: lnrpc.Lightning.DeleteAllPayments:input_type -> lnrpc.DeleteAllPaymentsRequest
	128, // 213: lnrpc.Lightning.DescribeGraph:input_type -> lnrpc.ChannelGraphRequest
	130, // 214: lnrpc.Lightning.GetNodeMetrics:input_type -> lnrpc.NodeMetricsRequest
	133, // 215: lnrpc.Lightning.GetChanInfo:input_type -> lnrpc.ChanInfoRequest
	122, // 216: lnrpc.Lightning.GetNodeInfo:input_type -> lnrpc.NodeInfoRequest
	113, // 217: lnrpc.Lightning.QueryRoutes:input_type -> lnrpc.QueryRoutesRequest
	134, // 218: lnrpc.Lightning.GetNetworkInfo:input_type -> lnrpc.NetworkInfoRequest
	136, // 219: lnrpc.Lightning.StopDaemon:input_type -> lnrpc.StopRequest
	138, // 220: lnrpc.Lightning.SubscribeChannelGraph:input_type -> lnrpc.GraphTopologySubscription
	165, // 221: lnrpc.Lightning.DebugLevel:input_type -> lnrpc.DebugLevelRequest
	170, // 222: lnrpc.Lightning.FeeReport:input_type -> lnrpc.FeeReportRequest
	173, // 223: lnrpc.Lightning.UpdateChannelPolicy:input_type -> lnrpc.PolicyUpdateRequest
	176, // 224: lnrpc.Lightning.ForwardingHistory:input_type -> lnrpc.ForwardingHistoryRequest
	179, // 225: lnrpc.Lightning.ExportChannelBackup:input_type -> lnrpc.ExportChannelBackupRequest
	182, // 226: lnrpc.Lightning.ExportAllChannelBackups:input_type -> lnrpc.ChanBackupExportRequest
	183, // 227: lnrpc.Lightning.VerifyChanBackup:input_type -> lnrpc.ChanBackupSnapshot
	185, // 228: lnrpc.Lightning.RestoreChannelBackups:input_type -> lnrpc.RestoreChanBackupRequest
	187, // 229: lnrpc.Lightning.SubscribeChannelBackups:input_type -> lnrpc.ChannelBackupSubscription
	190, // 230: lnrpc.Lightning.BakeMacaroon:input_type -> lnrpc.BakeMacaroonRequest
	192, // 231: lnrpc.Lightning.ListMacaroonIDs:input_type -> lnrpc.ListMacaroonIDsRequest
	194, // 232: lnrpc.Lightning.DeleteMacaroonID:input_type -> lnrpc.DeleteMacaroonIDRequest
	197, // 233: lnrpc.Lightning.ListPermissions:input_type -> lnrpc.ListPermissionsRequest
	203, // 234: lnrpc.Lightning.CheckMacaroonPermissions:input_type -> lnrpc.CheckMacPermRequest
	208, // 235: lnrpc.Lightning.RegisterRPCMiddleware:input_type -> lnrpc.RPCMiddlewareResponse
	22,  // 236: lnrpc.Lightning.SendCustomMessage:input_type -> lnrpc.SendCustomMessageRequest
	20,  // 237: lnrpc.Lightning.SubscribeCustomMessages:input_type -> lnrpc.SubscribeCustomMessagesRequest
	63,  // 238: lnrpc.Lightning.ListAliases:input_type -> lnrpc.ListAliasesRequest
	109, // 239: lnrpc.Lightning.WalletBalance:output_type -> lnrpc.WalletBalanceResponse
	112, // 240: lnrpc.Lightning.ChannelBalance:output_type -> lnrpc.ChannelBalanceResponse
	28,  // 241: lnrpc.Lightning.GetTransactions:output_type -> lnrpc.TransactionDetails
	40,  // 242: lnrpc.Lightning.EstimateFee:output_type -> lnrpc.EstimateFeeResponse
	44,  // 243: lnrpc.Lightning.SendCoins:output_type -> lnrpc.SendCoinsResponse
	46,  // 244: lnrpc.Lightning.ListUnspent:output_type -> lnrpc.ListUnspentResponse
	26,  // 245: lnrpc.Lightning.SubscribeTransactions:output_type -> lnrpc.Transaction
	42,  // 246: lnrpc.Lightning.SendMany:output_type -> lnrpc.SendManyResponse
	48,  // 247: lnrpc.Lightning.NewAddress:output_type -> lnrpc.NewAddressResponse
	50,  // 248: lnrpc.Lightning.SignMessage:output_type -> lnrpc.SignMessageResponse
	52,  // 249: lnrpc.Lightning.VerifyMessage:output_type -> lnrpc.VerifyMessageResponse
	54,  // 250: lnrpc.Lightning.ConnectPeer:output_type -> lnrpc.ConnectPeerResponse
	56,  // 251: lnrpc.Lightning.DisconnectPeer:output_type -> lnrpc.DisconnectPeerResponse
	72,  // 252: lnrpc.Lightning.ListPeers:output_type -> lnrpc.ListPeersResponse
	74,  // 253: lnrpc.Lightning.SubscribePeerEvents:output_type -> lnrpc.PeerEvent
	76,  // 254: lnrpc.Lightning.GetInfo:output_type -> lnrpc.GetInfoResponse
	78,  // 255: lnrpc.Lightning.GetRecoveryInfo:output_type -> lnrpc.GetRecoveryInfoResponse
	104, // 256: lnrpc.Lightning.PendingChannels:output_type -> lnrpc.PendingChannelsResponse
	61,  // 257: lnrpc.Lightning.ListChannels:output_type -> lnrpc.ListChannelsResponse
	106, // 258: lnrpc.Lightning.SubscribeChannelEvents:output_type -> lnrpc.ChannelEventUpdate
	68,  // 259: lnrpc.Lightning.ClosedChannels:output_type -> lnrpc.ClosedChannelsResponse
	35,  // 260: lnrpc.Lightning.OpenChannelSync:output_type -> lnrpc.ChannelPoint
	91,  // 261: lnrpc.Lightning.OpenChannel:output_type -> lnrpc.OpenStatusUpdate
	89,  // 262: lnrpc.Lightning.BatchOpenChannel:output_type -> lnrpc.BatchOpenChannelResponse
	101, // 263: lnrpc.Lightning.FundingStateStep:output_type -> lnrpc.FundingStateStepResp
	33,  // 264: lnrpc.Lightning.ChannelAcceptor:output_type -> lnrpc.ChannelAcceptRequest
	84,  // 265: lnrpc.Lightning.CloseChannel:output_type -> lnrpc.CloseStatusUpdate
	164, // 266: lnrpc.Lightning.AbandonChannel:output_type -> lnrpc.AbandonChannelResponse
	31,  // 267: lnrpc.Lightning.SendPayment:output_type -> lnrpc.SendResponse
	31,  // 268: lnrpc.Lightning.SendPaymentSync:output_type -> lnrpc.SendResponse
	31,  // 269: lnrpc.Lightning.SendToRoute:output_type -> lnrpc.SendResponse
	31,  // 270: lnrpc.Lightning.SendToRouteSync:output_type -> lnrpc.SendResponse
	150, // 271: lnrpc.Lightning.AddInvoice:output_type -> lnrpc.AddInvoiceResponse
	153, // 272: lnrpc.Lightning.ListInvoices:output_type -> lnrpc.ListInvoiceResponse
	147, // 273: lnrpc.Lightning.LookupInvoice:output_type -> lnrpc.Invoice
	147, // 274: lnrpc.Lightning.SubscribeInvoices:output_type -> lnrpc.Invoice
	168, // 275: lnrpc.Lightning.DecodePayReq:output_type -> lnrpc.PayReq
	158, // 276: lnrpc.Lightning.ListPayments:output_type -> lnrpc.ListPaymentsResponse
	161, // 277: lnrpc.Lightning.DeletePayment:output_type -> lnrpc.DeletePaymentResponse
	162, // 278: lnrpc.Lightning.DeleteAllPayments:output_type -> lnrpc.DeleteAllPaymentsResponse
	129, // 279: lnrpc.Lightning.DescribeGraph:output_type -> lnrpc.ChannelGraph
	131, // 280: lnrpc.Lightning.GetNodeMetrics:output_type -> lnrpc.NodeMetricsResponse
	127, // 281: lnrpc.Lightning.GetChanInfo:output_type -> lnrpc.ChannelEdge
	123, // 282: lnrpc.Lightning.GetNodeInfo:output_type -> lnrpc.NodeInfo
	116, // 283: lnrpc.Lightning.QueryRoutes:output_type -> lnrpc.QueryRoutesResponse
	135, // 284: lnrpc.Lightning.GetNetworkInfo:output_type -> lnrpc.NetworkInfo
	137, // 285: lnrpc.Lightning.StopDaemon:output_type -> lnrpc.StopResponse
	139, // 286: lnrpc.Lightning.SubscribeChannelGraph:output_type -> lnrpc.GraphTopologyUpdate
	166, // 287: lnrpc.Lightning.DebugLevel:output_type -> lnrpc.DebugLevelResponse
	172, // 288: lnrpc.Lightning.FeeReport:output_type -> lnrpc.FeeReportResponse
	175, // 289: lnrpc.Lightning.UpdateChannelPolicy:output_type -> lnrpc.PolicyUpdateResponse
	178, // 290: lnrpc.Lightning.ForwardingHistory:output_type -> lnrpc.ForwardingHistoryResponse
	180, // 291: lnrpc.Lightning.ExportChannelBackup:output_type -> lnrpc.ChannelBackup
	183, // 292: lnrpc.Lightning.ExportAllChannelBackups:output_type -> lnrpc.ChanBackupSnapshot
	188, // 293: lnrpc.Lightning.VerifyChanBackup:output_type -> lnrpc.VerifyChanBackupResponse
	186, // 294: lnrpc.Lightning.RestoreChannelBackups:output_type -> lnrpc.RestoreBackupResponse
	183, // 295: lnrpc.Lightning.SubscribeChannelBackups:output_type -> lnrpc.ChanBackupSnapshot
	191, // 296: lnrpc.Lightning.BakeMacaroon:output_type -> lnrpc.BakeMacaroonResponse
	193, // 297: lnrpc.Lightning.ListMacaroonIDs:output_type -> lnrpc.ListMacaroonIDsResponse
	195, // 298: lnrpc.Lightning.DeleteMacaroonID:output_type -> lnrpc.DeleteMacaroonIDResponse
	198, // 299: lnrpc.Lightning.ListPermissions:output_type -> lnrpc.ListPermissionsResponse
	204, // 300: lnrpc.Lightning.CheckMacaroonPermissions:output_type -> lnrpc.CheckMacPermResponse
	205, // 301: lnrpc.Lightning.RegisterRPCMiddleware:output_type -> lnrpc.RPCMiddlewareRequest
	23,  // 302: lnrpc.Lightning.SendCustomMessage:output_type -> lnrpc.SendCustomMessageResponse
	21,  // 303: lnrpc.Lightning.SubscribeCustomMessages:output_type -> lnrpc.CustomMessage
	64,  // 304: lnrpc.Lightning.ListAliases:output_type -> lnrpc.ListAliasesResponse
...
func file_lightning_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_lightning_proto_msgTypes[98].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*RouteBlindingRecord); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
