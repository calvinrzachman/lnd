...
func (s *Server) SendToRouteV2(ctx context.Context,
	...
	// NOTE(calvin): Do we expect the route to be empty when an onion
	// is provided? I suppose we could force callers to provide both, though
	// it does not seem technically necessary.
	if req.Route == nil {
