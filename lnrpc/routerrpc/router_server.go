...
func (s *Server) BuildRoute(_ context.Context,
	...
	// Set the source node based on the request, using the proxy's self-node as
	// the default if no source_pubkey is provided.
	...
	route, err := s.cfg.Router.BuildRouteFromSource(
