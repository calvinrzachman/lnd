...
var file_routerrpc_router_proto_rawDesc = []byte{
	...
	0x69, 0x6c, 0x75, 0x72, 0x65, 0x22, 0x7b, 0x0a, 0x11, 0x42, 0x75, 0x69, 0x6c, 0x64, 0x4f, 0x6e,
	...
	0x68, 0x12, 0x1f, 0x0a, 0x0b, 0x73, 0x65, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0x5f, 0x6b, 0x65, 0x79,
	0x18, 0x03, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x0a, 0x73, 0x65, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0x4b,
	...
	0x6f, 0x70, 0x50, 0x75, 0x62, 0x6b, 0x65, 0x79, 0x73, 0x22, 0x1c, 0x0a, 0x1a, 0x52, 0x65, 0x73,
	...
	0x52, 0x07, 0x68, 0x69, 0x73, 0x74, 0x6f, 0x72, 0x79, 0x22, 0xab, 0x03, 0x0a, 0x11, 0x42, 0x75,
	...
	0x75, 0x73, 0x74, 0x6f, 0x6d, 0x52, 0x65, 0x63, 0x6f, 0x72, 0x64, 0x73, 0x45, 0x6e, 0x74, 0x72,
	0x79, 0x52, 0x15, 0x66, 0x69, 0x72, 0x73, 0x74, 0x48, 0x6f, 0x70, 0x43, 0x75, 0x73, 0x74, 0x6f,
	0x6d, 0x52, 0x65, 0x63, 0x6f, 0x72, 0x64, 0x73, 0x12, 0x23, 0x0a, 0x0d, 0x73, 0x6f, 0x75, 0x72,
	0x63, 0x65, 0x5f, 0x70, 0x75, 0x62, 0x6b, 0x65, 0x79, 0x18, 0x07, 0x20, 0x01, 0x28, 0x0c, 0x52,
	0x0c, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x50, 0x75, 0x62, 0x6b, 0x65, 0x79, 0x1a, 0x48, 0x0a,
	...
	0x01, 0x12, 0x08, 0x0a, 0x04, 0x41, 0x55, 0x54, 0x4f, 0x10, 0x02, 0x32, 0xb3, 0x0e, 0x0a, 0x06,
	...
	0x65, 0x6d, 0x70, 0x74, 0x12, 0x49, 0x0a, 0x0a, 0x42, 0x75, 0x69, 0x6c, 0x64, 0x4f, 0x6e, 0x69,
...
var file_routerrpc_router_proto_goTypes = []interface{}{
	...
	(*BuildOnionRequest)(nil),                  // 13: routerrpc.BuildOnionRequest
	(*BuildOnionResponse)(nil),                 // 14: routerrpc.BuildOnionResponse
...
var file_routerrpc_router_proto_depIdxs = []int32{
	...
	63, // 8: routerrpc.BuildOnionRequest.route:type_name -> lnrpc.Route
	21, // 9: routerrpc.QueryMissionControlResponse.pairs:type_name -> routerrpc.PairHistory
	21, // 10: routerrpc.XImportMissionControlRequest.pairs:type_name -> routerrpc.PairHistory
	22, // 11: routerrpc.PairHistory.history:type_name -> routerrpc.PairData
	27, // 12: routerrpc.GetMissionControlConfigResponse.config:type_name -> routerrpc.MissionControlConfig
	27, // 13: routerrpc.SetMissionControlConfigRequest.config:type_name -> routerrpc.MissionControlConfig
	4,  // 14: routerrpc.MissionControlConfig.model:type_name -> routerrpc.MissionControlConfig.ProbabilityModel
	29, // 15: routerrpc.MissionControlConfig.apriori:type_name -> routerrpc.AprioriParameters
	28, // 16: routerrpc.MissionControlConfig.bimodal:type_name -> routerrpc.BimodalParameters
	22, // 17: routerrpc.QueryProbabilityResponse.history:type_name -> routerrpc.PairData
	56, // 18: routerrpc.BuildRouteRequest.first_hop_custom_records:type_name -> routerrpc.BuildRouteRequest.FirstHopCustomRecordsEntry
	63, // 19: routerrpc.BuildRouteResponse.route:type_name -> lnrpc.Route
	5,  // 20: routerrpc.HtlcEvent.event_type:type_name -> routerrpc.HtlcEvent.EventType
	37, // 21: routerrpc.HtlcEvent.forward_event:type_name -> routerrpc.ForwardEvent
	38, // 22: routerrpc.HtlcEvent.forward_fail_event:type_name -> routerrpc.ForwardFailEvent
	39, // 23: routerrpc.HtlcEvent.settle_event:type_name -> routerrpc.SettleEvent
	42, // 24: routerrpc.HtlcEvent.link_fail_event:type_name -> routerrpc.LinkFailEvent
	41, // 25: routerrpc.HtlcEvent.subscribed_event:type_name -> routerrpc.SubscribedEvent
	40, // 26: routerrpc.HtlcEvent.final_htlc_event:type_name -> routerrpc.FinalHtlcEvent
	36, // 27: routerrpc.ForwardEvent.info:type_name -> routerrpc.HtlcInfo
	36, // 28: routerrpc.LinkFailEvent.info:type_name -> routerrpc.HtlcInfo
	65, // 29: routerrpc.LinkFailEvent.wire_failure:type_name -> lnrpc.Failure.FailureCode
	...
	66, // 32: routerrpc.PaymentStatus.htlcs:type_name -> lnrpc.HTLCAttempt
	44, // 33: routerrpc.ForwardHtlcInterceptRequest.incoming_circuit_key:type_name -> routerrpc.CircuitKey
	57, // 34: routerrpc.ForwardHtlcInterceptRequest.custom_records:type_name -> routerrpc.ForwardHtlcInterceptRequest.CustomRecordsEntry
	58, // 35: routerrpc.ForwardHtlcInterceptRequest.in_wire_custom_records:type_name -> routerrpc.ForwardHtlcInterceptRequest.InWireCustomRecordsEntry
	44, // 36: routerrpc.ForwardHtlcInterceptResponse.incoming_circuit_key:type_name -> routerrpc.CircuitKey
	2,  // 37: routerrpc.ForwardHtlcInterceptResponse.action:type_name -> routerrpc.ResolveHoldForwardAction
	65, // 38: routerrpc.ForwardHtlcInterceptResponse.failure_code:type_name -> lnrpc.Failure.FailureCode
	59, // 39: routerrpc.ForwardHtlcInterceptResponse.out_wire_custom_records:type_name -> routerrpc.ForwardHtlcInterceptResponse.OutWireCustomRecordsEntry
	67, // 40: routerrpc.UpdateChanStatusRequest.chan_point:type_name -> lnrpc.ChannelPoint
	3,  // 41: routerrpc.UpdateChanStatusRequest.action:type_name -> routerrpc.ChanStatusAction
	68, // 42: routerrpc.AddAliasesRequest.alias_maps:type_name -> lnrpc.AliasMap
	68, // 43: routerrpc.AddAliasesResponse.alias_maps:type_name -> lnrpc.AliasMap
	68, // 44: routerrpc.DeleteAliasesRequest.alias_maps:type_name -> lnrpc.AliasMap
	68, // 45: routerrpc.DeleteAliasesResponse.alias_maps:type_name -> lnrpc.AliasMap
	...
	13, // 52: routerrpc.Router.BuildOnion:input_type -> routerrpc.BuildOnionRequest
	15, // 53: routerrpc.Router.ResetMissionControl:input_type -> routerrpc.ResetMissionControlRequest
	17, // 54: routerrpc.Router.QueryMissionControl:input_type -> routerrpc.QueryMissionControlRequest
	19, // 55: routerrpc.Router.XImportMissionControl:input_type -> routerrpc.XImportMissionControlRequest
	23, // 56: routerrpc.Router.GetMissionControlConfig:input_type -> routerrpc.GetMissionControlConfigRequest
	25, // 57: routerrpc.Router.SetMissionControlConfig:input_type -> routerrpc.SetMissionControlConfigRequest
	...
	14, // 73: routerrpc.Router.BuildOnion:output_type -> routerrpc.BuildOnionResponse
	16, // 74: routerrpc.Router.ResetMissionControl:output_type -> routerrpc.ResetMissionControlResponse
	18, // 75: routerrpc.Router.QueryMissionControl:output_type -> routerrpc.QueryMissionControlResponse
	20, // 76: routerrpc.Router.XImportMissionControl:output_type -> routerrpc.XImportMissionControlResponse
	24, // 77: routerrpc.Router.GetMissionControlConfig:output_type -> routerrpc.GetMissionControlConfigResponse
	26, // 78: routerrpc.Router.SetMissionControlConfig:output_type -> routerrpc.SetMissionControlConfigResponse
	31, // 79: routerrpc.Router.QueryProbability:output_type -> routerrpc.QueryProbabilityResponse
	33, // 80: routerrpc.Router.BuildRoute:output_type -> routerrpc.BuildRouteResponse
	35, // 81: routerrpc.Router.SubscribeHtlcEvents:output_type -> routerrpc.HtlcEvent
	43, // 82: routerrpc.Router.SendPayment:output_type -> routerrpc.PaymentStatus
	43, // 83: routerrpc.Router.TrackPayment:output_type -> routerrpc.PaymentStatus
	45, // 84: routerrpc.Router.HtlcInterceptor:output_type -> routerrpc.ForwardHtlcInterceptRequest
	48, // 85: routerrpc.Router.UpdateChanStatus:output_type -> routerrpc.UpdateChanStatusResponse
	50, // 86: routerrpc.Router.XAddLocalChanAliases:output_type -> routerrpc.AddAliasesResponse
	52, // 87: routerrpc.Router.XDeleteLocalChanAliases:output_type -> routerrpc.DeleteAliasesResponse
