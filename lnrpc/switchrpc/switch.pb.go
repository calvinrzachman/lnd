...
const (
	...
	// An HTLC with the same ID has already been processed. The HTLC may be in
	// flight. The client may proceed to tracking the result of the attempt.
	...
	// The server encountered a failure during the durable write of the
	// idempotency anchor (InitAttempt) and cannot determine if the htlc has been
	// processed via the current or a prior request. The client MUST retry the
	// request with the same ID to resolve the uncertainty.
	ErrorCode_AMBIGUOUS_STATE ErrorCode = 9
)
...
// The success response is now empty. A nil error on the RPC call is the
// signal for success.
...
// SendOnionFailureDetails is a structured error payload that is attached to a
// gRPC status in case of a definitive, application-level failure.
type SendOnionFailureDetails struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	// A code representing the type of error that occurred.
...
var file_switchrpc_switch_proto_rawDesc = []byte{
	...
	0x38, 0x01, 0x22, 0x13, 0x0a, 0x11, 0x53, 0x65, 0x6e, 0x64, 0x4f, 0x6e, 0x69, 0x6f, 0x6e, 0x52,
	0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x73, 0x0a, 0x17, 0x53, 0x65, 0x6e, 0x64, 0x4f,
	0x6e, 0x69, 0x6f, 0x6e, 0x46, 0x61, 0x69, 0x6c, 0x75, 0x72, 0x65, 0x44, 0x65, 0x74, 0x61, 0x69,
	0x6c, 0x73, 0x12, 0x33, 0x0a, 0x0a, 0x65, 0x72, 0x72, 0x6f, 0x72, 0x5f, 0x63, 0x6f, 0x64, 0x65,
	0x18, 0x01, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x14, 0x2e, 0x73, 0x77, 0x69, 0x74, 0x63, 0x68, 0x72,
	0x70, 0x63, 0x2e, 0x45, 0x72, 0x72, 0x6f, 0x72, 0x43, 0x6f, 0x64, 0x65, 0x52, 0x09, 0x65, 0x72,
	...
	0x50, 0x75, 0x62, 0x6b, 0x65, 0x79, 0x73, 0x2a, 0xda, 0x01, 0x0a, 0x09, 0x45, 0x72, 0x72, 0x6f,
	...
	0x07, 0x12, 0x0c, 0x0a, 0x08, 0x49, 0x4e, 0x54, 0x45, 0x52, 0x4e, 0x41, 0x4c, 0x10, 0x08, 0x12,
	0x13, 0x0a, 0x0f, 0x41, 0x4d, 0x42, 0x49, 0x47, 0x55, 0x4f, 0x55, 0x53, 0x5f, 0x53, 0x54, 0x41,
	0x54, 0x45, 0x10, 0x09, 0x32, 0xe6, 0x01, 0x0a, 0x06, 0x53, 0x77, 0x69, 0x74, 0x63, 0x68, 0x12,
	...
	0x4f, 0x6e, 0x69, 0x6f, 0x6e, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x42, 0x31, 0x5a,
...
var file_switchrpc_switch_proto_msgTypes = make([]protoimpl.MessageInfo, 8)
var file_switchrpc_switch_proto_goTypes = []interface{}{
	...
	(*BuildOnionRequest)(nil),       // 6: switchrpc.BuildOnionRequest
	(*BuildOnionResponse)(nil),      // 7: switchrpc.BuildOnionResponse
	nil,                             // 8: switchrpc.SendOnionRequest.CustomRecordsEntry
	(*lnrpc.Route)(nil),             // 9: lnrpc.Route
}
var file_switchrpc_switch_proto_depIdxs = []int32{
	8, // 0: switchrpc.SendOnionRequest.custom_records:type_name -> switchrpc.SendOnionRequest.CustomRecordsEntry
	...
	9, // 3: switchrpc.BuildOnionRequest.route:type_name -> lnrpc.Route
	1, // 4: switchrpc.Switch.SendOnion:input_type -> switchrpc.SendOnionRequest
	4, // 5: switchrpc.Switch.TrackOnion:input_type -> switchrpc.TrackOnionRequest
	6, // 6: switchrpc.Switch.BuildOnion:input_type -> switchrpc.BuildOnionRequest
	2, // 7: switchrpc.Switch.SendOnion:output_type -> switchrpc.SendOnionResponse
	5, // 8: switchrpc.Switch.TrackOnion:output_type -> switchrpc.TrackOnionResponse
	7, // 9: switchrpc.Switch.BuildOnion:output_type -> switchrpc.BuildOnionResponse
