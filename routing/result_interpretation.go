...
func (i *interpretedResult) processFail(
	...
	if errSourceIdx == nil {
		fmt.Printf("payment outcome unknown: %v", rt)
	...
	// and try again.
	default:
		fmt.Printf("payment outcome middle hop: %v", rt)
