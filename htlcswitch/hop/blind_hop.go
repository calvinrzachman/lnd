...
func (b *BlindHopProcessor) DecryptBlindedPayload(nodeID keychain.SingleKeyECDH, blindingPoint *btcec.PublicKey,
...
func (b *BlindHopProcessor) NextBlindingPoint(nodeID keychain.SingleKeyECDH, blindingPoint *btcec.PublicKey) (
