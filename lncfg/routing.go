...
type Routing struct {
	...
	RemoteTracking bool `long:"remotetracking" description:"If true, all HTLC attempts will be considered managed by a remote routing (payment life-cycle) entity. This allows for external control over when the attempt information is deleted."`
}
