...
type Config struct {
	...
	// NodeKeyECDH is the the ECDH capable wrapper of our our persistent
	// node ID private key (either directly or via abstraction). This is
	// necessary in order to process onions for hops in a blinded route.
	// NOTE(9/20/22): Does this make the above 'ServerPubKey' redundant?
...
func (p *Brontide) addLink(chanPoint *wire.OutPoint,
	...
	linkCfg := htlcswitch.ChannelLinkConfig{
		Switch:                 p.cfg.Switch.(*htlcswitch.Switch),
		Peer:                   p,
