...
type Config struct {
	...
	// NOTE(9/25/22): We will likely favor route blinding as a "protocol option"
	// RouteBlinding                 bool          `long:"routeblinding" description:"Enable processing of blind hops as described by route blinding proposal"`
