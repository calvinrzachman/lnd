...
// ExtractRecords() requires us to define this type and associated (en/de)code methods,
// as it precludes us from being able to leverage the 'record' package's "primitive"
// TLV types. Instead it pushes us to define his own custom type so that we may satisfy
// the RecordProducer interface{}. It might be nice to be able to take advantage of the
// primitive types that the 'record' package offers. No type casting.
// The change to the RecordProducer{} interface is said to "reduce line noise a bit".
// I am not quite sure what this means or how it would achieve anything not already achieved by
// a reliable byte stream abstraction. Are there any more details on why this was swapped?
